...
void APurpleLeafCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &APurpleLeafCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &APurpleLeafCharacter::MoveRight);
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &APurpleLeafCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &APurpleLeafCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &APurpleLeafCharacter::OnResetVR);
}


void APurpleLeafCharacter::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void APurpleLeafCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void APurpleLeafCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}

void APurpleLeafCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void APurpleLeafCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void APurpleLeafCharacter::MoveForward(float Value)
{
...
void APurpleLeafCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
...
void APurpleLeafCharacter::StopRun()
{
